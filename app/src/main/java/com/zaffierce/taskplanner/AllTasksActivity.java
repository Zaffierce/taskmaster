...
public class AllTasksActivity extends AppCompatActivity implements TasksAdapter.OnTaskInteractionListener {
...
//                .build();
//        client.newCall(request).enqueue(new OkHTTPResponse(AllTasksActivity.this));
